<header class="bg-gray-700 sticky top-0 z-50" x-data="dropdown()">
     {{-- Care about people's approval and you will be their prisoner. --}}
         ...
         <div class="container flex items-center h-16 justify-between md:justify-start ">
                 ...
                 <a x-on:click = "show()" class="flex flex-col items-center justify-center order-last md:order-first md:px-6 px-4 bg-white bg-opacity-25 text-white font-semibold h-full cursor-pointer">
